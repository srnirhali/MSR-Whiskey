...
public class RepositoriesPicker {
    ...
    private static final String USERNAME_AND_TOKEN = "srnirhali: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";
    ...
    public static void collectRepositories(int starsLimit, int contributorsLimit, int commitsLimit)
        ...
        log.info("Found " + allRepositories.size() + " Java GitHub repositories with at least "+starsLimit+" stars.");
        log.info("Filtered " + filteredRepositories.size()
                + " Java GitHub repositories with at least "+starsLimit+" stars, one POM file, " + contributorsLimit
